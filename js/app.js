...
import { t, getLang, setLang } from "./i18n.js?v=1.5.7";
import {
...
} from "./store.js?v=1.5.7";
import { generateHandout, HandoutError, PDFDocument, notesAreaWouldBeEmpty, sourceAspectRatioOfDocument } from "./pdfEngine.js?v=1.5.7";
